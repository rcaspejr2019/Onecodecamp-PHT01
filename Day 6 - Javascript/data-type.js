//Data types
//Numbers:Represent numeric values. e.g. 5,3,1.5
let age = 25;
console.log("The value of age is:",age)
console.log("The type of age is:",typeof(age))

//Strings: textual data enclosed in '' or "", e.g. abcd1234!#$%
let name = "King"; //string
...
console.log("The type of this car:", typeof(car));

//Unintensional absence of value
let city;
